	...
	*/
	class DirectTimerThread extends Thread {
		...
		public DirectTimerThread(String name) {
			this.name = name;
			logger.info("DirectTimerThread constructed " + name);
		}
		...
		@Override
		public void run() {
			this.setName("SRV Send DirectTimer " + name);
			logger.info("DirectTimerThread started " + name);
			while (running) {
				try {
				...
				logger.info("DirectTimerThread running " + name);
			...
			logger.info("DirectTimerThread stopped " + name);
		}
		...
		public void shutdown() {
			...
			logger.info("DirectTimerThread initiating shutdown " + name);
		}
	}
